<template>
  <b-card title="Booking Disbag Manifest">
...
import searchBooOutgoingOp from '@/@fake-db/data/other/searchBooOutgoingOp'
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          label: 'No. Disbag Manifest',
          field: 'no_disbag_manifest',
          thClass: 'text-center',
          tdClass: 'text-center',
        },
        {
