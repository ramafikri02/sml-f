...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2022 at 12:17 PM
...
CREATE TABLE `armada` (
  `no_body_kendaraan` varchar(50) NOT NULL,
  `no_kode_kendaraan` varchar(30) DEFAULT NULL,
  `no_body` varchar(30) NOT NULL,
  `merk_kendaraan` varchar(30) NOT NULL,
  `model_kendaraan` varchar(30) NOT NULL,
  `jenis` varchar(30) NOT NULL,
  `kode_jenis` varchar(20) DEFAULT NULL,
  `status_kepemilikan` varchar(50) DEFAULT NULL,
  `kode_status_kepemilikan` varchar(20) DEFAULT NULL,
...
INSERT INTO `armada` (`no_body_kendaraan`, `no_kode_kendaraan`, `no_body`, `merk_kendaraan`, `model_kendaraan`, `jenis`, `kode_jenis`, `status_kepemilikan`, `kode_status_kepemilikan`, `tahun`, `no_polisi`, `fungsi`, `cabang`, `createdAt`, `UpdatedAt`) VALUES
...
CREATE TABLE `cabang` (
  ...
  `kode_region` varchar(255) DEFAULT NULL,
  `kode_provinsi` varchar(255) DEFAULT NULL,
  `kode_iata` varchar(255) DEFAULT NULL,
  `jenis_cabang` varchar(255) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `cabang` (`kode_cabang`, `nama_cabang`, `kode_region`, `kode_provinsi`, `kode_iata`, `jenis_cabang`, `createdAt`, `updatedAt`) VALUES
('AMQ', 'Ambon', 'Maluku', 'Maluku', 'Pattimura (AMQ)', 'FULL', '2021-12-14 15:35:11', '2021-12-14 15:35:46'),
...
INSERT INTO `coverage_area` (`kode_kota`, `nama_tujuan`, `kode_cabang`, `cabang`, `jarak`, `waktu_tempuh`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `faktur` (
  ...
  `jenis_dokumen` enum('Faktur/Invoice','Faktur Pajak') NOT NULL,
...
INSERT INTO `faktur` (`id_faktur`, `jenis_dokumen`, `penanggung_jawab`, `jabatan`, `cabang`, `kantor`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `grup_menu` (
  ...
  `keterangan_grup` varchar(255) NOT NULL,
  `status_grup` enum('Aktif','Tidak Aktif') NOT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `grup_menu` (`kode_grup`, `nama_grup`, `keterangan_grup`, `status_grup`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `helper` (
  ...
  `cabang` varchar(50) NOT NULL,
  `tugas` enum('Pengantaran','Pengambilan','Pengantaran & Pengambilan','') NOT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `helper` (`kode_kurir`, `nama_kurir`, `cabang`, `tugas`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `kantor_cabang` (
  ...
  `kode_kantor_terakhir` varchar(255) DEFAULT NULL,
  ...
  `telepon_kepala_cabang` varchar(255) DEFAULT NULL,
  `email_kepala_cabang` varchar(255) DEFAULT NULL,
  `nama_pic_operasional` varchar(255) DEFAULT NULL,
  `telepon_pic_operasional` varchar(255) DEFAULT NULL,
  `email_pic_operasional` varchar(255) DEFAULT NULL,
  `nama_pic_cs` varchar(255) DEFAULT NULL,
  `telepon_pic_cs` varchar(255) DEFAULT NULL,
  `email_pic_cs` varchar(255) DEFAULT NULL,
  `nama_pic_billing` varchar(255) DEFAULT NULL,
  `telepon_pic_billing` varchar(255) DEFAULT NULL,
  `email_pic_billing` varchar(255) DEFAULT NULL,
  `nama_pic_akunting` varchar(255) DEFAULT NULL,
  `telepon_pic_akunting` varchar(255) DEFAULT NULL,
  `email_pic_akunting` varchar(255) DEFAULT NULL,
...
INSERT INTO `kantor_cabang` (`kode_kantor`, `region`, `provinsi`, `cabang`, `tipe_kantor`, `ppn`, `kode_kantor_terakhir`, `nama_kantor`, `nama_perusahaan`, `alamat`, `latitude`, `longitude`, `npwp`, `komisi`, `kode_pos`, `telepon`, `fax`, `email`, `nama_kepala_cabang`, `telepon_kepala_cabang`, `email_kepala_cabang`, `nama_pic_operasional`, `telepon_pic_operasional`, `email_pic_operasional`, `nama_pic_cs`, `telepon_pic_cs`, `email_pic_cs`, `nama_pic_billing`, `telepon_pic_billing`, `email_pic_billing`, `nama_pic_akunting`, `telepon_pic_akunting`, `email_pic_akunting`, `tipe_perusahaan`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `karyawan` (
  ...
  `kantor` varchar(50) NOT NULL,
  `kode_daerah` varchar(50) DEFAULT NULL,
  `kode_tlc` varchar(50) DEFAULT NULL,
  ...
  `status_karyawan` enum('Kontrak','Tetap','Percobaan','Permanen') NOT NULL,
...
INSERT INTO `karyawan` (`kode_karyawan`, `kode_pekerjaan`, `kode_departemen`, `manager`, `nama_depan`, `nama_tengah`, `nama_akhir`, `alamat`, `cabang`, `kantor`, `kode_daerah`, `kode_tlc`, `tempat_lahir`, `tanggal_lahir`, `tanggal_masuk_kerja`, `jenis_kelamin`, `kode_pos`, `status_pernikahan`, `tanggungan`, `pendidikan_terakhir`, `status_karyawan`, `deskripsi`, `nama_istri`, `nama_anak`, `no_telepon`, `email`, `status`, `foto`, `createdAt`, `updatedAt`) VALUES
('JKT.OPS.0001', 'OP SML', 'OPERASIONAL', 'Jawa Barat', 'Viper', '-', '-', 'HEAD OFFICE CIBUBUR', 'JKT', 'SML CIbubur', '0', '', 'Olympus', '1899-11-29', '1899-12-31', 'Laki - Laki', '12', 'Belum Menikah', '0', 'SMA', 'Tetap', '-', '-', '0', '85123212308', 'viper@gmail.com', 'Aktif', 'SMLasasd', '2021-12-14 18:01:25', '2022-01-06 09:32:04'),
('JKT.OPS.0002', 'OP SML', 'OPERASIONAL', 'Jawa Barat', 'Viper', '-', '-', 'HEAD OFFICE CIBUBUR', 'JKT', 'SML CIbubur', '0', '', 'Olympus', '0000-00-00', '0000-00-00', 'Laki - Laki', '0', 'Belum Menikah', '0', 'SMA', 'Tetap', '-', '-', '0', '6267567', 'viper@gmail.com', 'Aktif', 'SMLasasd', '2022-01-10 15:13:50', '2022-01-10 15:13:50'),
...
('JKT.OPS.0004', 'OP SML', 'OPERASIONAL', 'Jawa Barat', 'Viper', '-', '-', 'HEAD OFFICE CIBUBUR', 'JKT', 'SML CIbubur', '0', '', 'Olympus', '1999-07-20', '2021-04-20', 'Laki - Laki', '1231', 'Belum Menikah', '0', 'SMA', 'Tetap', '-', '-', '0', '84212312311', 'viper@gmail.com', 'Aktif', 'SMLasasd', '2022-01-19 13:28:37', '2022-01-20 09:12:52'),
...
--
-- Table structure for table `kontrak_pelanggan`
--

CREATE TABLE `kontrak_pelanggan` (
...
--
-- Dumping data for table `kontrak_pelanggan`
--

INSERT INTO `kontrak_pelanggan` (`nomor_kontrak`, `cabang`, `pelanggan`, `periode_dari`, `periode_sampai`, `deskripsi`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `kurir` (
  ...
  `tugas` enum('Pengantaran','Pengambilan','Pengantaran & Pengambilan') NOT NULL,
  `kendaraan` enum('Motorcycle','L300','Blindvand','L300 Jumbo','Mobil Penumpang','Engkel','Double Engkel','Ertiga','Pickup','Semua Jenis Kendaraan') NOT NULL,
...
INSERT INTO `kurir` (`kode_kurir`, `kata_sandi`, `nama_kurir`, `no_telepon`, `cabang`, `kantor`, `area`, `tugas`, `kendaraan`, `status`, `company_id`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `pelanggan` (
  ...
  `cabang_asal` varchar(50) NOT NULL,
  ...
  `pilihan_transaksi` varchar(50) NOT NULL,
  `pembulatan_kilo` varchar(50) NOT NULL,
  `diskon_pelanggan` varchar(50) DEFAULT NULL,
  `logo_pelanggan` enum('Operasional','Tidak','Ya') DEFAULT NULL,
  `single_akun` enum('Operasional','Tidak','Ya') NOT NULL,
  `pelanggan_nasional` enum('Operasional','Tidak','Ya') NOT NULL,
  `kode_grup` varchar(50) DEFAULT NULL,
  `distribusi_stok_awb` enum('Operasional','Tidak','Ya') DEFAULT NULL,
  `masa_efektif` date DEFAULT NULL,
  ...
  `pekerjaan_kontak` varchar(50) DEFAULT NULL,
  `telepon_kontak` varchar(50) DEFAULT NULL,
  `email_kontak` varchar(50) DEFAULT NULL,
  `periode_penagihan` enum('COD Price','Bulanan','Dua Mingguan','Mingguan') DEFAULT NULL,
  `top` varchar(50) DEFAULT NULL,
  `penagihan_dengan_pod_balik` enum('Operasional','Tidak','Ya') DEFAULT NULL,
  `penagihan_dengan_email` enum('Operasional','Tidak','Ya') DEFAULT NULL,
  `jenis_pembayaran` varchar(20) DEFAULT NULL,
  `no_virtual_account` varchar(50) NOT NULL,
  `hari_kerja` varchar(50) DEFAULT NULL,
  `jam_kerja` time DEFAULT NULL,
  `penjemputan` enum('Operasional','Tidak','Ya') DEFAULT NULL,
  `jadwal_penjemputan` varchar(50) DEFAULT NULL,
  `waktu_penjemputan` time DEFAULT NULL,
  `sales` varchar(255) DEFAULT NULL,
  `periode_awal` date DEFAULT NULL,
  `periode_akhir` date DEFAULT NULL,
  `target_nilai` varchar(50) DEFAULT NULL,
  `telepon_sales` varchar(20) DEFAULT NULL,
...
INSERT INTO `pelanggan` (`kode_pelanggan`, `jenis_akun`, `cabang_asal`, `kantor_asal`, `kode_resi`, `jenis_industri`, `vendor_integration`, `pilihan_transaksi`, `pembulatan_kilo`, `diskon_pelanggan`, `logo_pelanggan`, `single_akun`, `pelanggan_nasional`, `kode_grup`, `distribusi_stok_awb`, `masa_efektif`, `masa_berakhir`, `nama_pelanggan`, `divisi`, `departemen`, `alamat`, `kota`, `kode_pos`, `telepon`, `no_fax`, `email`, `website`, `npwp`, `nppkp`, `nama_kontak`, `pekerjaan_kontak`, `telepon_kontak`, `email_kontak`, `periode_penagihan`, `top`, `penagihan_dengan_pod_balik`, `penagihan_dengan_email`, `jenis_pembayaran`, `no_virtual_account`, `hari_kerja`, `jam_kerja`, `penjemputan`, `jadwal_penjemputan`, `waktu_penjemputan`, `sales`, `periode_awal`, `periode_akhir`, `target_nilai`, `telepon_sales`, `email_sales`, `dibuat_oleh`, `diajukan_oleh`, `tanggal_dibuat`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `pengguna` (
  ...
  `grup_pengguna` varchar(255) DEFAULT NULL,
...
INSERT INTO `pengguna` (`kode_pengguna`, `nama_pengguna`, `kata_sandi`, `kode_cabang`, `kode_kantor`, `grup_pengguna`, `akun_id`, `pegawai_id`, `multiple_login`, `company_id`, `status`, `createdAt`, `updatedAt`) VALUES
('JETT', 'Jett', '$2b$10$0G1KVIv91h0NgnXvU6QVJeD8dPjiwf.eI9luaQ9Px63hbo3eS946e', 'JKT', 'JKT001', 'Marketing', '3', '3', 'Tidak', NULL, 'Tidak Aktif', '2021-12-14 11:56:15', '2022-05-13 14:51:07'),
('MRDCK', 'Murdock', '$2b$10$TMAcIhnzTSWIrPGUtu1aJuv25D8f4DJSXsVzIDD7fkrPKnGQoWdwm', 'JKT', 'JKT001', 'Super Admin', '3', '3', 'Tidak', 'SML', 'Tidak Aktif', '2021-12-23 12:59:14', '2021-12-23 12:59:14');
...
CREATE TABLE `vendor` (
  ...
  `jenis_akun_vendor` enum('Port to Door','Port to Port','Vendor Udara','Vendor Darat','Vendor Laut') NOT NULL,
  `moda_vendor` enum('Udara','Darat','Laut') DEFAULT NULL,
  ...
  `pekerjaan_kontak` varchar(30) DEFAULT NULL,
  `telepon_kontak` varchar(50) DEFAULT NULL,
  `email_kontak` varchar(50) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL
...
INSERT INTO `vendor` (`kode_vendor`, `jenis_akun_vendor`, `moda_vendor`, `nama_vendor`, `cabang`, `alamat`, `kota`, `kode_pos`, `telepon`, `no_fax`, `email`, `website`, `npwp`, `nama_kontak`, `pekerjaan_kontak`, `telepon_kontak`, `email_kontak`, `createdAt`, `updatedAt`) VALUES
...
--
ALTER TABLE `armada`
  ADD PRIMARY KEY (`no_body_kendaraan`);
...
--
-- Indexes for table `kontrak_pelanggan`
--
ALTER TABLE `kontrak_pelanggan`
